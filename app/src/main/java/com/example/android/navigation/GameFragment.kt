            ...
            if (-1 != checkedId) {
                ...
                if (answers[answerIndex] == currentQuestion.answers[0]) {
                    ...
                    if (questionIndex < numQuestions) {
                        ...
                        //view.findNavController().navigate(R.id.action_gameFragment_to_gameWonFragment). After add SAFE-ARGS dependency it´s not necesary (R.id.action_gameFragment_to_gameWonFragment)
                        view.findNavController().navigate(GameFragmentDirections.actionGameFragmentToGameWonFragment(numQuestions, questionIndex))
                    }
                } else {
                    // Game over! A wrong answer sends us to the gameOverFragment. After add SAFE-ARGS dependency it´s not necesary (R.id.action_gameFragment_to_gameOverFragment2)
